...
birdplayer_image = 'img/bird1.png'
sealevel_image = 'img/base.png'


def flappygame():
	your_score = 0
	horizontal = int(window_width/5)
	vertical = int(window_width/5)
	ground = 0
	mytempheight = 100
	...
	while True:
		...
		# finding the width of score img from numbers.
		for num in numbers:
			width += game_images['scoreimages'][num].get_width()
		Xoffset = (window_width - width)/1.1

		# Blitting the img on the window.
		for num in numbers:
...
if __name__ == "__main__":
	...
	# Load all the img which we will use in the game

	# img for displaying score
